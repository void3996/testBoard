...
<head>
	...
	<style>
		...
		section.replyList div.userInfo .memNickname { font-size:24px; font-weight:bold; }
					  ...
					  $(data).each(function(){
					   ...
					   console.log(data);
						...
						str += "<li data-repNum='" + this.repNum + "'>" //"<li data-gdsNum='" + this.gdsNum + "'>"
					     + "<div class='userInfo'>"
					     + "<span class='memNickname'>" + this.memNickname + "</span>"
			...
			<form role="form" method="post">
				...
				<div class="goods">
				 ...
				 <div class="goodsInfo">
				  ...
				  <p class="gdsStock">
				   <span>재고 </span><fmt:formatNumber pattern="###,###,###" value="${view.gdsStock}" /> 켤레
				  </p>
				...
				<p class="cartStock">
				 ...
				 <div class="gdsDes"><h1>상품 설명</h1>${view.gdsDes}</div>
				</div>
				...
				<div id="reply">
				 ...
				 <c:forEach items="${reply}" var="reply">
				  <li>
				      <div class="userInfo">
				       <span class="memNickname">${reply.memNickname}</span>
				       <span class="date"><fmt:formatDate value="${reply.repDate}" pattern="yyyy-MM-dd HH:mm:ss" /></span>
				      </div>
...
$(document).ready(function() {
	var gdsNum = getParameters("n");
	$.ajax({
		url : "/admin/getImages",
		data: JSON.stringify({"gdsNum" : gdsNum}),
		dataType: "json",
		...
		for(var i = 0; i < data.length;i++){
			...
			str += "<img src=/display?fileName="+ data[i].imagePath+">";
