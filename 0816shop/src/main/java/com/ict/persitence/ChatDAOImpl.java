...
public class ChatDAOImpl implements ChatDAO{
	...
	private static String namespace = "com.mvc.mapper.ChatMapper";
	...
	public String getPartner(ChatroomVO vo) throws Exception {
			List<ChatVO> mvo = session.selectList(namespace+".getPartner", vo);
	...
	public void updateReadTime(int gdsNum, String memId, String seller_USER_user_id) throws Exception {
		...
		map.put("seller_USER_user_id", seller_USER_user_id);
		map.put("user_user_id", memId);
		map.put("gdsNum", memId);
...
HashMap<String, Object> map = new HashMap<String, Object> ();
	...
	public int getAllCount(String str) {
		...
		map.put("seller_USER_user_id", str);
